...
<html lang="es" class="sr">
    ...
    <body>
      ...
      <small class="text-muted">Ismael Heras Salvador</small>
        ...
        <main>
        <div class="menu load-hidden">
            <a href="proyectoDWES/DWES.php">
                <img src="images/PHP-logo.png">
            </a>
            <a href="proyectoDWEC/DWEC.php">
                <img src="images/javascript-1.png"></a>
            <a href="proyectoDAW/DAW.php">
                <img src="images/apache.png"></a>
            <a href="proyectoDIW/DIW.php">
                <img src="images/htmlcss.jpg"></a>  
        </div> 
